...
(function(){
  ...
  const GAMES = [
    ...
    {slug: 'kingdomino',       name: 'Kingdomino',             subtitle: 'Domaines cases × couronnes',
     rules: 'https://blueorangegames.eu/wp-content/uploads/2017/04/KINGDOMINO_rules_ML.pdf'}, // multilingue, FR inclus
    {slug: 'queendomino',      name: 'Queendomino',            subtitle: 'Domaines, bâtiments, pièces',
     rules: 'https://blueorangegames.eu/wp-content/uploads/2017/12/QUEENDOMINO_rules_ML.pdf'}, // multilingue, FR inclus
    {slug: '7wondersduel',     name: '7 Wonders Duel',         subtitle: 'Civil, Panthéon, Agora',
     rules: 'https://www.rprod.com/fr/games/7-wonders-duel'}, // pas de PDF officiel direct en ligne
    /* lowWins : le plus petit total gagne — lu par la feuille (classement),
       l'historique (re-tri à l'édition) et les stats (sens du record) */
    {slug: 'skyjo',            name: 'Skyjo',                  subtitle: 'Manches cumulées, doublement calculé', lowWins: true,
     rules: 'https://www.magilano.com/products/skyjo'} // pas de PDF FR officiel en ligne
  ];
